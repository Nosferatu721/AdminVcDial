...
def obtenerListaCampanas(codTarea, ipVcidial, usuarioVcidial, contrasenaVcidial):
    ...
    try:
        ...
        Respuesta = requests.get(f"http://" + str(usuarioVcidial) + ":" + str(contrasenaVcidial) + "@" + str(
            ipVcidial) + "/vicidial/admin.php?ADD=10")
...
"""
            ...
            try:
                ...
                if int(Respuesta.status_code) == 200:
                    ...
                    if Comprobar == True:
                        ...
                        print(campanaSeleccionada, ">>>" ,Respuesta)
            ...
            if continuarEjecucion == True:
                ...
                if nuevoMetodoMarcado == metodoMarcado:
                    ...
                    requests.get(f"http://{ipVicidial}/vicidial/non_agent_api.php?source=test&user={usuarioVcidial}&pass={contrasenaVcidial}&function=update_campaign&campaign_id={campanaSeleccionada}&dial_method={nuevoMetodoMarcado}")
                    ...
                    if contador >= intervaloAdmin:
                        ...
                        if int(agentesEsperando) > 1:
                            ...
                            if float(nuevoRatio) == float(nivelMarcado):
                                ...
                                requests.get(f"http://{ipVicidial}/vicidial/non_agent_api.php?source=test&user={usuarioVcidial}&pass={contrasenaVcidial}&function=update_campaign&campaign_id={campanaSeleccionada}&auto_dial_level={nuevoRatio}")
        ...
        try:
            ...
            with connectionMySQL.cursor() as cursor:
                ...
                if continuarEjecucion == True:
                    ...
                    Respuesta = requests.get(f"http://" + str(USUARIO_VCIDIAL) + ":" + str(CONTRASENA_VCIDIAL) + "@" + str(IP_VCIDIAL) + "/vicidial/admin.php")
                    if Respuesta.status_code == 200:
                        continuarEjecucion = True
                    else:
                        continuarEjecucion = False
